...
function navigateToInterstatePage(merchant, targetUrl) {
  var url = targetUrl ? merchant.url + "?redirect=" + encodeURIComponent(targetUrl) : merchant.url;
...
function onMerchantSelect(merchant, href) {
  framework.extension.fireEvent('trackEvent', { data: 'Serp' });
  (0, _utils.navigateToInterstatePage)(merchant, href);
}
...
function findLinks() {
  ...
  var _loop = function _loop(i) {
    var item = $items[i];
    if (item.getAttribute('youbehero-serp-processed') === '1') return 'continue';
    item.setAttribute('youbehero-serp-processed', '1');
    var href = item.getAttribute('href');
    framework.extension.fireEvent('findMerchantByUrl', { data: href }, function (merchant) {
      if (!merchant) return;

      var mount = document.createElement('div');
      (0, _jquery2.default)(item).parent().prepend(mount);
    ...
    value: function getStyles() {
      return {
        ...
        linkBt: {
          fontFamily: 'Lato, Tahoma, sans-serif',
          fontSize: 13,
          background: _commonStyles2.default.primary,
          color: '#fff',
          padding: 10,
          marginLeft: 25,
          marginRight: 25,
          cursor: 'pointer',
          boxShadow: '2px 2px 3px 1px #7b7b7b'
        },
        textStyle: {
          fontFamily: 'Lato, Tahoma, sans-serif',
          fontSize: 14,
        ...
        closeBt: {
          ...
          fontSize: '13px',
          marginTop: '8px',
          color: _commonStyles2.default.primary
        },
        fontBold: {
          fontWeight: 'bold'
        },
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            _react2.default.createElement(
              'span',
              { style: styles.justRegular },
              ' της αξίας των αγορών σου στον σκοπό σου,'
            ),
            _react2.default.createElement(
              'span',
              { style: styles.fontBold },
...
,
 (function(module, exports) {
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
 ...
 (function(module, exports) {
module.exports = "data:image/png;base64,"
